...
The project demonstrates a complete end-to-end machine learning pipeline for handling large-scale retail sales data. Note that this me file explain the steps executed in prediction-pipeline.ipynb
